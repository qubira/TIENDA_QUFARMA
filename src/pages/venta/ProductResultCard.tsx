...
export default function ProductResultCard({
  ...
  return (
    <button
      ...
      className="group relative flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white text-left shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:translate-y-0"
    >
        ...
        <div className="mt-auto flex items-center justify-between pt-1">
          ...
          <span
            className={`text-[11px] font-medium ${
              sinStock ? "text-rose-500" : "text-slate-400"
            }`}
          >
